...
from Test.laba2.database.scripts.db import Data
...
class AddDataWin(QWidget):
    ...
    def initUI(self):
        ...
        self.setGeometry(100, 100, 400, 1500)
        ...
        self.close_button = QPushButton('Назад')
        layout = QVBoxLayout()
    ...
    def add_order(self, acceptance_date=None):
